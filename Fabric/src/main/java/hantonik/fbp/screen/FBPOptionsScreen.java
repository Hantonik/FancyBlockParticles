    ...
    protected void init() {
        ...
        switch (this.page) {
            ...
            case 2 -> {
                ...
                this.addRenderableWidget(new FBPToggleButton(this.width / 2 - 138, this.height / 13 + 158, 275, 20, new TranslatableComponent("button.fbp.smart_breaking"), this.config::isSmartBreaking, button -> this.config.setSmartBreaking(!this.config.isSmartBreaking()), (button, stack, mouseX, mouseY) -> this.renderTooltip(stack, new TranslatableComponent("tooltip.fbp.smart_breaking").append(CommonComponents.NEW_LINE).append(new TranslatableComponent("tooltip.fbp.default")).append(new TranslatableComponent("button.fbp." + defaultConfig.isSmartBreaking()).withStyle(defaultConfig.isSmartBreaking() ? ChatFormatting.GREEN : ChatFormatting.RED)), mouseX, mouseY)));
                this.addRenderableWidget(new FBPToggleButton(this.width / 2 - 138, this.height / 13 + 181, 275, 20, new TranslatableComponent("button.fbp.low_traction"), this.config::isLowTraction, button -> this.config.setLowTraction(!this.config.isLowTraction()), (button, stack, mouseX, mouseY) -> this.renderTooltip(stack, new TranslatableComponent("tooltip.fbp.low_traction").append(CommonComponents.NEW_LINE).append(new TranslatableComponent("tooltip.fbp.default")).append(new TranslatableComponent("button.fbp." + defaultConfig.isLowTraction()).withStyle(defaultConfig.isLowTraction() ? ChatFormatting.GREEN : ChatFormatting.RED)), mouseX, mouseY)));
