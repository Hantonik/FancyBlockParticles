    ...
    protected void init() {
        ...
        switch (this.page) {
            case 1 -> {
                ...
                minLifetimeSlider.setSupplier(() -> new FBPSliderButton(this.width / 2 - 138, this.height / 13 + 89, 275, new TranslatableComponent("button.fbp.min_lifetime"), new TranslatableComponent("button.fbp.ticks"), this.config.getMinLifetime(), FancyBlockParticles.CONFIG.getMinLifetime(), 0, 100, 1, button -> {
                ...
                maxLifetimeSlider.setSupplier(() -> new FBPSliderButton(this.width / 2 - 138, this.height / 13 + 112, 275, new TranslatableComponent("button.fbp.max_lifetime"), new TranslatableComponent("button.fbp.ticks"), this.config.getMaxLifetime(), FancyBlockParticles.CONFIG.getMaxLifetime(), 0, 100, 1, button -> {
                ...
                this.addRenderableWidget(minLifetimeSlider.get());
                this.addRenderableWidget(maxLifetimeSlider.get());

                this.addRenderableWidget(new FBPSliderButton(this.width / 2 - 138, this.height / 13 + 135, 275, new TranslatableComponent("button.fbp.scale_multiplier"), new TextComponent("x"), this.config.getScaleMultiplier(), FancyBlockParticles.CONFIG.getScaleMultiplier(), 0.0D, 2.0D, 0.05D, button -> this.config.setScaleMultiplier(button.getValue()), () -> !FancyBlockParticles.CONFIG.isLocked(), (widget, stack, mouseX, mouseY) -> this.renderTooltip(stack, new TranslatableComponent("tooltip.fbp.scale_multiplier").append(CommonComponents.NEW_LINE).append(new TranslatableComponent("tooltip.fbp.default").append(new TextComponent(String.valueOf(defaultConfig.getScaleMultiplier())).withStyle(ChatFormatting.YELLOW))), mouseX, mouseY)));
                this.addRenderableWidget(new FBPSliderButton(this.width / 2 - 138, this.height / 13 + 158, 275, new TranslatableComponent("button.fbp.rotation_multiplier"), new TextComponent("x"), this.config.getRotationMultiplier(), FancyBlockParticles.CONFIG.getRotationMultiplier(), 0.0D, 2.0D, 0.05D, button -> this.config.setRotationMultiplier(button.getValue()), () -> !FancyBlockParticles.CONFIG.isLocked(), (widget, stack, mouseX, mouseY) -> this.renderTooltip(stack, new TranslatableComponent("tooltip.fbp.rotation_multiplier").append(CommonComponents.NEW_LINE).append(new TranslatableComponent("tooltip.fbp.default").append(new TextComponent(String.valueOf(defaultConfig.getRotationMultiplier())).withStyle(ChatFormatting.YELLOW))), mouseX, mouseY)));
                this.addRenderableWidget(new FBPSliderButton(this.width / 2 - 138, this.height / 13 + 181, 275, new TranslatableComponent("button.fbp.gravity_multiplier"), new TextComponent("x"), this.config.getGravityMultiplier(), FancyBlockParticles.CONFIG.getGravityMultiplier(), 0.0D, 2.0D, 0.05D, button -> this.config.setGravityMultiplier(button.getValue()), () -> !FancyBlockParticles.CONFIG.isLocked(), (widget, stack, mouseX, mouseY) -> this.renderTooltip(stack, new TranslatableComponent("tooltip.fbp.gravity_multiplier").append(CommonComponents.NEW_LINE).append(new TranslatableComponent("tooltip.fbp.default").append(new TextComponent(String.valueOf(defaultConfig.getGravityMultiplier())).withStyle(ChatFormatting.YELLOW))), mouseX, mouseY)));
            ...
            case 2 -> {
                ...
                this.addRenderableWidget(new FBPToggleButton(this.width / 2 - 138, this.height / 13 + 89, 275, 20, new TranslatableComponent("button.fbp.fancy_snow"), this.config::isFancySnow, button -> this.config.setFancySnow(!this.config.isFancySnow()), (button, stack, mouseX, mouseY) -> this.renderTooltip(stack, new TranslatableComponent("tooltip.fbp.fancy_snow").append(CommonComponents.NEW_LINE).append(new TranslatableComponent("tooltip.fbp.default")).append(new TranslatableComponent("button.fbp." + defaultConfig.isFancySnow()).withStyle(defaultConfig.isFancySnow() ? ChatFormatting.GREEN : ChatFormatting.RED)), mouseX, mouseY)));
                this.addRenderableWidget(new FBPToggleButton(this.width / 2 - 138, this.height / 13 + 112, 275, 20, new TranslatableComponent("button.fbp.fancy_place_animation"), this.config::isFancyPlaceAnimation, button -> this.config.setFancyPlaceAnimation(!this.config.isFancyPlaceAnimation()), (button, stack, mouseX, mouseY) -> this.renderTooltip(stack, new TranslatableComponent("tooltip.fbp.fancy_place_animation").append(CommonComponents.NEW_LINE).append(new TranslatableComponent("tooltip.fbp.default")).append(new TranslatableComponent("button.fbp." + defaultConfig.isFancyPlaceAnimation()).withStyle(defaultConfig.isFancyPlaceAnimation() ? ChatFormatting.GREEN : ChatFormatting.RED)), mouseX, mouseY)));
                this.addRenderableWidget(new FBPToggleButton(this.width / 2 - 138, this.height / 13 + 135, 275, 20, new TranslatableComponent("button.fbp.cartoon_mode"), this.config::isCartoonMode, button -> this.config.setCartoonMode(!this.config.isCartoonMode()), (button, stack, mouseX, mouseY) -> this.renderTooltip(stack, new TranslatableComponent("tooltip.fbp.cartoon_mode").append(CommonComponents.NEW_LINE).append(new TranslatableComponent("tooltip.fbp.default")).append(new TranslatableComponent("button.fbp." + defaultConfig.isCartoonMode()).withStyle(defaultConfig.isCartoonMode() ? ChatFormatting.GREEN : ChatFormatting.RED)), mouseX, mouseY)));
                this.addRenderableWidget(new FBPToggleButton(this.width / 2 - 138, this.height / 13 + 158, 275, 20, new TranslatableComponent("button.fbp.cull_particles"), this.config::isCullParticles, button -> this.config.setCullParticles(!this.config.isCullParticles()), (button, stack, mouseX, mouseY) -> this.renderTooltip(stack, new TranslatableComponent("tooltip.fbp.cull_particles").append(CommonComponents.NEW_LINE).append(new TranslatableComponent("tooltip.fbp.default")).append(new TranslatableComponent("button.fbp." + defaultConfig.isCullParticles()).withStyle(defaultConfig.isCullParticles() ? ChatFormatting.GREEN : ChatFormatting.RED)), mouseX, mouseY)));
                this.addRenderableWidget(new FBPToggleButton(this.width / 2 - 138, this.height / 13 + 181, 275, 20, new TranslatableComponent("button.fbp.smart_breaking"), this.config::isSmartBreaking, button -> this.config.setSmartBreaking(!this.config.isSmartBreaking()), (button, stack, mouseX, mouseY) -> this.renderTooltip(stack, new TranslatableComponent("tooltip.fbp.smart_breaking").append(CommonComponents.NEW_LINE).append(new TranslatableComponent("tooltip.fbp.default")).append(new TranslatableComponent("button.fbp." + defaultConfig.isSmartBreaking()).withStyle(defaultConfig.isSmartBreaking() ? ChatFormatting.GREEN : ChatFormatting.RED)), mouseX, mouseY)));
                this.addRenderableWidget(new FBPToggleButton(this.width / 2 - 138, this.height / 13 + 204, 275, 20, new TranslatableComponent("button.fbp.low_traction"), this.config::isLowTraction, button -> this.config.setLowTraction(!this.config.isLowTraction()), (button, stack, mouseX, mouseY) -> this.renderTooltip(stack, new TranslatableComponent("tooltip.fbp.low_traction").append(CommonComponents.NEW_LINE).append(new TranslatableComponent("tooltip.fbp.default")).append(new TranslatableComponent("button.fbp." + defaultConfig.isLowTraction()).withStyle(defaultConfig.isLowTraction() ? ChatFormatting.GREEN : ChatFormatting.RED)), mouseX, mouseY)));
            }

            case 3 -> {
                this.addRenderableWidget(new FBPToggleButton(this.width / 2 - 138, this.height / 13 + 20, 275, 20, new TranslatableComponent("button.fbp.spawn_while_frozen"), this.config::isSpawnWhileFrozen, button -> this.config.setSpawnWhileFrozen(!this.config.isSpawnWhileFrozen()), (button, stack, mouseX, mouseY) -> this.renderTooltip(stack, new TranslatableComponent("tooltip.fbp.spawn_while_frozen").append(CommonComponents.NEW_LINE).append(new TranslatableComponent("tooltip.fbp.default")).append(new TranslatableComponent("button.fbp." + defaultConfig.isSpawnWhileFrozen()).withStyle(defaultConfig.isSpawnWhileFrozen() ? ChatFormatting.GREEN : ChatFormatting.RED)), mouseX, mouseY)));
                ...
                this.addRenderableWidget(new FBPToggleButton(this.width / 2 - 138, this.height / 13 + 89, 275, 20, new TranslatableComponent("button.fbp.bounce_off_walls"), this.config::isBounceOffWalls, button -> this.config.setBounceOffWalls(!this.config.isBounceOffWalls()), (button, stack, mouseX, mouseY) -> this.renderTooltip(stack, new TranslatableComponent("tooltip.fbp.bounce_off_walls").append(CommonComponents.NEW_LINE).append(new TranslatableComponent("tooltip.fbp.default")).append(new TranslatableComponent("button.fbp." + defaultConfig.isBounceOffWalls()).withStyle(defaultConfig.isBounceOffWalls() ? ChatFormatting.GREEN : ChatFormatting.RED)), mouseX, mouseY)));
                this.addRenderableWidget(new FBPToggleButton(this.width / 2 - 138, this.height / 13 + 112, 275, 20, new TranslatableComponent("button.fbp.entity_collision"), this.config::isEntityCollision, button -> this.config.setEntityCollision(!this.config.isEntityCollision()), (button, stack, mouseX, mouseY) -> this.renderTooltip(stack, new TranslatableComponent("tooltip.fbp.entity_collision").append(CommonComponents.NEW_LINE).append(new TranslatableComponent("tooltip.fbp.default")).append(new TranslatableComponent("button.fbp." + defaultConfig.isEntityCollision()).withStyle(defaultConfig.isEntityCollision() ? ChatFormatting.GREEN : ChatFormatting.RED)), mouseX, mouseY)));
                this.addRenderableWidget(new FBPToggleButton(this.width / 2 - 138, this.height / 13 + 135, 275, 20, new TranslatableComponent("button.fbp.water_physics"), this.config::isWaterPhysics, button -> this.config.setWaterPhysics(!this.config.isWaterPhysics()), (button, stack, mouseX, mouseY) -> this.renderTooltip(stack, new TranslatableComponent("tooltip.fbp.water_physics").append(CommonComponents.NEW_LINE).append(new TranslatableComponent("tooltip.fbp.default")).append(new TranslatableComponent("button.fbp." + defaultConfig.isWaterPhysics()).withStyle(defaultConfig.isWaterPhysics() ? ChatFormatting.GREEN : ChatFormatting.RED)), mouseX, mouseY)));
                this.addRenderableWidget(new FBPToggleButton(this.width / 2 - 138, this.height / 13 + 158, 275, 20, new TranslatableComponent("button.fbp.random_scale"), this.config::isRandomScale, button -> this.config.setRandomScale(!this.config.isRandomScale()), (button, stack, mouseX, mouseY) -> this.renderTooltip(stack, new TranslatableComponent("tooltip.fbp.random_scale").append(CommonComponents.NEW_LINE).append(new TranslatableComponent("tooltip.fbp.default")).append(new TranslatableComponent("button.fbp." + defaultConfig.isRandomScale()).withStyle(defaultConfig.isRandomScale() ? ChatFormatting.GREEN : ChatFormatting.RED)), mouseX, mouseY)));
                this.addRenderableWidget(new FBPToggleButton(this.width / 2 - 138, this.height / 13 + 181, 275, 20, new TranslatableComponent("button.fbp.random_rotation"), this.config::isRandomRotation, button -> this.config.setRandomRotation(!this.config.isRandomRotation()), (button, stack, mouseX, mouseY) -> this.renderTooltip(stack, new TranslatableComponent("tooltip.fbp.random_rotation").append(CommonComponents.NEW_LINE).append(new TranslatableComponent("tooltip.fbp.default")).append(new TranslatableComponent("button.fbp." + defaultConfig.isRandomRotation()).withStyle(defaultConfig.isRandomRotation() ? ChatFormatting.GREEN : ChatFormatting.RED)), mouseX, mouseY)));
                this.addRenderableWidget(new FBPToggleButton(this.width / 2 - 138, this.height / 13 + 204, 275, 20, new TranslatableComponent("button.fbp.random_fading_speed"), this.config::isRandomFadingSpeed, button -> this.config.setRandomFadingSpeed(!this.config.isRandomFadingSpeed()), (button, stack, mouseX, mouseY) -> this.renderTooltip(stack, new TranslatableComponent("tooltip.fbp.random_fading_speed").append(CommonComponents.NEW_LINE).append(new TranslatableComponent("tooltip.fbp.default")).append(new TranslatableComponent("button.fbp." + defaultConfig.isRandomFadingSpeed()).withStyle(defaultConfig.isRandomFadingSpeed() ? ChatFormatting.GREEN : ChatFormatting.RED)), mouseX, mouseY)));
            }

            case 4 -> this.addRenderableWidget(new FBPToggleButton(this.width / 2 - 138, this.height / 13 + 20, 275, 20, new TranslatableComponent("button.fbp.smooth_animation_lighting"), this.config::isSmoothAnimationLighting, button -> this.config.setSmoothAnimationLighting(!this.config.isSmoothAnimationLighting()), (button, stack, mouseX, mouseY) -> this.renderTooltip(stack, new TranslatableComponent("tooltip.fbp.smooth_animation_lighting").append(CommonComponents.NEW_LINE).append(new TranslatableComponent("tooltip.fbp.default")).append(new TranslatableComponent("button.fbp." + defaultConfig.isSmoothAnimationLighting()).withStyle(defaultConfig.isSmoothAnimationLighting() ? ChatFormatting.GREEN : ChatFormatting.RED)), mouseX, mouseY)));
        }
        ...
        var reloadButton = this.addRenderableWidget(new Button(this.width / 2 - 138, this.height / 13 + 250, 275, 20, new TranslatableComponent("button.fbp.reload"), button -> {
        ...
        this.addRenderableWidget(new Button(this.width / 2 - 135 - 3, this.height / 13 + 273, 135, 20, new TranslatableComponent("button.fbp.reset"), button -> this.minecraft.setScreen(new ConfirmScreen(confirm -> {
            if (confirm) {
                this.config.reset();
        ...
        var doneButton = this.addRenderableWidget(new Button(this.width / 2 + 2, this.height / 13 + 273, 135, 20, new TranslatableComponent("button.fbp.done"), button -> this.onDone()));
