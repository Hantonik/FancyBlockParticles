...
public class FBPBlacklistScreen extends Screen {
    ...
    public void render(PoseStack stack, int mouseX, int mouseY, float partialTick) {
        ...
        if (this.animationButton.get().isMouseOver(mouseX, mouseY)) {
            drawCenteredString(stack, this.font, Component.translatable("tooltip.fbp.animation").withStyle(ChatFormatting.BOLD, ChatFormatting.GREEN), this.animationButton.get().x + 30, this.animationButton.get().y + 30 - 42, 0);

            drawCenteredString(stack, this.font, this.animationButton.get().isBlackListed() ? Component.translatable("tooltip.fbp.remove").withStyle(ChatFormatting.BOLD, ChatFormatting.RED) : Component.translatable("tooltip.fbp.add").withStyle(ChatFormatting.BOLD, ChatFormatting.GREEN), this.animationButton.get().x + 30, this.animationButton.get().y + 30 + 35, 0);
        }

        if (this.particleButton.get().isMouseOver(mouseX, mouseY)) {
            drawCenteredString(stack, this.font, Component.translatable("tooltip.fbp.particles").withStyle(ChatFormatting.BOLD, ChatFormatting.GREEN), this.particleButton.get().x + 30, this.particleButton.get().y + 30 - 42, 0);

            drawCenteredString(stack, this.font, this.particleButton.get().isBlackListed() ? Component.translatable("tooltip.fbp.remove").withStyle(ChatFormatting.BOLD, ChatFormatting.RED) : Component.translatable("tooltip.fbp.add").withStyle(ChatFormatting.BOLD, ChatFormatting.GREEN), this.particleButton.get().x + 30, this.particleButton.get().y + 30 + 35, 0);
        }
