...
public class FBPTerrainScreen extends FBPAbstractOptionsScreen {
    ...
    protected void initOptions() {
        ...
        var particleBlacklistButton = this.openScreenButton(Component.translatable("screen.fbp.terrain.particle_blacklist").append("..."), () -> null /*new FBPParticleBlacklistScreen(this, this.config)*/, Component.translatable("tooltip.fbp.common.option_unsupported")); // TODO
