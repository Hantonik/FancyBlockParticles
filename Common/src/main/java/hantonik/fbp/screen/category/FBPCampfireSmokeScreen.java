...
public class FBPCampfireSmokeScreen extends FBPAbstractOptionsScreen {
    ...
    protected void initOptions() {
        this.list.addSmall(
                new FBPToggleButton(150, 20, Component.translatable("button.fbp.campfire_smoke.fancy_campfire_smoke_particles"), this.config.campfireSmoke::isEnabled, button -> this.config.campfireSmoke.setEnabled(!this.config.campfireSmoke.isEnabled()), Component.translatable("tooltip.fbp.campfire_smoke.fancy_campfire_smoke_particles").append(CommonComponents.NEW_LINE).append(CommonComponents.NEW_LINE).append(Component.translatable("tooltip.fbp.default")).append(Component.translatable("button.fbp.common." + FBPConfig.DEFAULT_CONFIG.campfireSmoke.isEnabled()))),
                new FBPToggleButton(150, 20, Component.translatable("button.fbp.common.spawn_while_frozen"), this.config.campfireSmoke::isSpawnWhileFrozen, button -> this.config.campfireSmoke.setSpawnWhileFrozen(!this.config.campfireSmoke.isSpawnWhileFrozen()), Component.translatable("tooltip.fbp.common.spawn_while_frozen").append(CommonComponents.NEW_LINE).append(CommonComponents.NEW_LINE).append(Component.translatable("tooltip.fbp.default")).append(Component.translatable("button.fbp.common." + FBPConfig.DEFAULT_CONFIG.campfireSmoke.isSpawnWhileFrozen()))),

                new FBPToggleButton(150, 20, Component.translatable("button.fbp.common.random_size"), this.config.campfireSmoke::isRandomSize, button -> this.config.campfireSmoke.setRandomSize(!this.config.campfireSmoke.isRandomSize()), Component.translatable("tooltip.fbp.common.random_size").append(CommonComponents.NEW_LINE).append(CommonComponents.NEW_LINE).append(Component.translatable("tooltip.fbp.default")).append(Component.translatable("button.fbp.common." + FBPConfig.DEFAULT_CONFIG.campfireSmoke.isRandomSize()))),
                new FBPToggleButton(150, 20, Component.translatable("button.fbp.common.random_fading_speed"), this.config.campfireSmoke::isRandomFadingSpeed, button -> this.config.campfireSmoke.setRandomFadingSpeed(!this.config.campfireSmoke.isRandomFadingSpeed()), Component.translatable("tooltip.fbp.common.random_fading_speed").append(CommonComponents.NEW_LINE).append(CommonComponents.NEW_LINE).append(Component.translatable("tooltip.fbp.default")).append(Component.translatable("button.fbp.common." + FBPConfig.DEFAULT_CONFIG.campfireSmoke.isRandomFadingSpeed())), () -> !FancyBlockParticles.CONFIG.global.isLocked()),
