...
public class FBPSnowScreen extends FBPAbstractOptionsScreen {
    ...
    protected void initOptions() {
        ...
        var waterPhysicsButton = new FBPToggleButton(150, 20, Component.translatable("button.fbp.common.water_physics"), this.config.snow::isWaterPhysics, button -> this.config.snow.setWaterPhysics(!this.config.snow.isWaterPhysics()), /*this.tooltip(Component.translatable("tooltip.fbp.common.water_physics").append(CommonComponents.NEW_LINE).append(CommonComponents.NEW_LINE).append(Component.translatable("tooltip.fbp.default")).append(Component.translatable("button.fbp.common." + FBPConfig.DEFAULT_CONFIG.snow.isWaterPhysics())))*/ Component.translatable("tooltip.fbp.common.option_unsupported"), () -> false); // TODO
