...
public class FBPSnowScreen extends FBPAbstractOptionsScreen {
    ...
    protected void initOptions() {
        ...
        this.list.addSmall(
                ...
                new FBPToggleButton(150, 20, new TranslatableComponent("button.fbp.common.water_physics"), this.config.snow::isWaterPhysics, button -> this.config.snow.setWaterPhysics(!this.config.snow.isWaterPhysics()), new TranslatableComponent("tooltip.fbp.common.water_physics").append(CommonComponents.NEW_LINE).append(CommonComponents.NEW_LINE).append(new TranslatableComponent("tooltip.fbp.default")).append(new TranslatableComponent("button.fbp.common." + FBPConfig.DEFAULT_CONFIG.snow.isWaterPhysics()))),
