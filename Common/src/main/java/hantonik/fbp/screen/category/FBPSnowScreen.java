...
public class FBPSnowScreen extends FBPAbstractOptionsScreen {
    ...
    protected void initOptions() {
        ...
        }, () -> (!this.config.snow.isInfiniteDuration() && !this.config.global.isInfiniteDuration()) && !FancyBlockParticles.CONFIG.global.isLocked(), new TranslatableComponent("tooltip.fbp.common.min_lifetime").append(CommonComponents.NEW_LINE).append(CommonComponents.NEW_LINE).append(new TranslatableComponent("tooltip.fbp.default")).append(new TextComponent(String.valueOf(FBPConfig.DEFAULT_CONFIG.snow.getMinLifetime())).withStyle(ChatFormatting.YELLOW))));
        ...
        }, () -> (!this.config.snow.isInfiniteDuration() && !this.config.global.isInfiniteDuration()) && !FancyBlockParticles.CONFIG.global.isLocked(), new TranslatableComponent("tooltip.fbp.common.max_lifetime").append(CommonComponents.NEW_LINE).append(CommonComponents.NEW_LINE).append(new TranslatableComponent("tooltip.fbp.default")).append(new TextComponent(String.valueOf(FBPConfig.DEFAULT_CONFIG.snow.getMaxLifetime())).withStyle(ChatFormatting.YELLOW))));

        var waterPhysicsButton = new FBPToggleButton(150, 20, new TranslatableComponent("button.fbp.common.water_physics"), this.config.snow::isWaterPhysics, button -> this.config.snow.setWaterPhysics(!this.config.snow.isWaterPhysics()), /*this.tooltip(new TranslatableComponent("tooltip.fbp.common.water_physics").append(CommonComponents.NEW_LINE).append(CommonComponents.NEW_LINE).append(new TranslatableComponent("tooltip.fbp.default")).append(new TranslatableComponent("button.fbp.common." + FBPConfig.DEFAULT_CONFIG.snow.isWaterPhysics())))*/ new TranslatableComponent("tooltip.fbp.common.option_unsupported"), () -> false); // TODO
        ...
        this.list.addSmall(
                ...
                new FBPToggleButton(150, 20, new TranslatableComponent("button.fbp.common.random_fading_speed"), this.config.snow::isRandomFadingSpeed, button -> this.config.snow.setRandomFadingSpeed(!this.config.snow.isRandomFadingSpeed()), new TranslatableComponent("tooltip.fbp.common.random_fading_speed").append(CommonComponents.NEW_LINE).append(CommonComponents.NEW_LINE).append(new TranslatableComponent("tooltip.fbp.default")).append(new TranslatableComponent("button.fbp.common." + FBPConfig.DEFAULT_CONFIG.snow.isRandomFadingSpeed())), () -> (!this.config.snow.isInfiniteDuration() && !this.config.global.isInfiniteDuration()) && !FancyBlockParticles.CONFIG.global.isLocked()),

                minLifetimeSlider.get(),
                maxLifetimeSlider.get(),

                new FBPSliderButton(150, 20, new TranslatableComponent("button.fbp.common.render_distance").append(": "), new TranslatableComponent("tooltip.fbp.chunks"), this.config.snow.getRenderDistance(), FancyBlockParticles.CONFIG.snow.getRenderDistance(), 2, 32, 1, button -> this.config.snow.setRenderDistance(button.getValueInt()), () -> !FancyBlockParticles.CONFIG.global.isLocked(), new TranslatableComponent("tooltip.fbp.common.render_distance").append(CommonComponents.NEW_LINE).append(CommonComponents.NEW_LINE).append(new TranslatableComponent("tooltip.fbp.default")).append(new TextComponent(String.valueOf(FBPConfig.DEFAULT_CONFIG.snow.getRenderDistance())).withStyle(ChatFormatting.YELLOW))),
                ...
                new FBPSliderButton(150, 20, new TranslatableComponent("button.fbp.snow.particle_density").append(": "), new TextComponent("x"), this.config.snow.getParticleDensity(), FancyBlockParticles.CONFIG.snow.getParticleDensity(), 0.0D, 2.0D, 0.05D, button -> this.config.snow.setParticleDensity(button.getValueFloat()), () -> !FancyBlockParticles.CONFIG.global.isLocked(), new TranslatableComponent("tooltip.fbp.snow.particle_density").append(CommonComponents.NEW_LINE).append(CommonComponents.NEW_LINE).append(new TranslatableComponent("tooltip.fbp.default")).append(new TextComponent(String.valueOf(FBPConfig.DEFAULT_CONFIG.snow.getParticleDensity())).withStyle(ChatFormatting.YELLOW))),

                new FBPSliderButton(150, 20, new TranslatableComponent("button.fbp.common.size_multiplier").append(": "), new TextComponent("x"), this.config.snow.getSizeMultiplier(), FancyBlockParticles.CONFIG.snow.getSizeMultiplier(), 0.01D, 2.0D, 0.05D, button -> this.config.snow.setSizeMultiplier(button.getValueFloat()), () -> !FancyBlockParticles.CONFIG.global.isLocked(), new TranslatableComponent("tooltip.fbp.common.size_multiplier").append(CommonComponents.NEW_LINE).append(CommonComponents.NEW_LINE).append(new TranslatableComponent("tooltip.fbp.default")).append(new TextComponent(String.valueOf(FBPConfig.DEFAULT_CONFIG.snow.getSizeMultiplier())).withStyle(ChatFormatting.YELLOW))),
                new FBPSliderButton(150, 20, new TranslatableComponent("button.fbp.common.rotation_multiplier").append(": "), new TextComponent("x"), this.config.snow.getRotationMultiplier(), FancyBlockParticles.CONFIG.snow.getRotationMultiplier(), 0.0D, 2.0D, 0.05D, button -> this.config.snow.setRotationMultiplier(button.getValueFloat()), () -> !FancyBlockParticles.CONFIG.global.isLocked(), new TranslatableComponent("tooltip.fbp.common.rotation_multiplier").append(CommonComponents.NEW_LINE).append(CommonComponents.NEW_LINE).append(new TranslatableComponent("tooltip.fbp.default")).append(new TextComponent(String.valueOf(FBPConfig.DEFAULT_CONFIG.snow.getRotationMultiplier())).withStyle(ChatFormatting.YELLOW))),
                new FBPSliderButton(150, 20, new TranslatableComponent("button.fbp.common.gravity_multiplier").append(": "), new TextComponent("x"), this.config.snow.getGravityMultiplier(), FancyBlockParticles.CONFIG.snow.getGravityMultiplier(), 0.1D, 2.0D, 0.05D, button -> this.config.snow.setGravityMultiplier(button.getValueFloat()), () -> !FancyBlockParticles.CONFIG.global.isLocked(), new TranslatableComponent("tooltip.fbp.common.gravity_multiplier").append(CommonComponents.NEW_LINE).append(CommonComponents.NEW_LINE).append(new TranslatableComponent("tooltip.fbp.default")).append(new TextComponent(String.valueOf(FBPConfig.DEFAULT_CONFIG.snow.getGravityMultiplier())).withStyle(ChatFormatting.YELLOW)))
        );
    }
