...
public final class FBPConfig implements IFBPConfig<FBPConfig> {
    ...
    public void load() {
        ...
        try {
            ...
            this.campfireSmoke.load(json.has("campfireSmoke") ? json.getAsJsonObject("campfireSmoke") : new JsonObject());
    ...
    public static class Global implements IFBPConfig<Global> {
        ...
        public void load(JsonObject json) {
            ...
            this.disableOculusWarning = json.has("disableOculusWarning") ? json.getAsJsonPrimitive("disableOculusWarning").getAsBoolean() : DEFAULT_DISABLE_OCULUS_WARNING;
    ...
    public static class CampfireSmoke implements IFBPConfig<CampfireSmoke> {
        ...
        public void load(JsonObject json) {
            ...
            this.transparency = json.has("transparency") ? json.getAsJsonPrimitive("transparency").getAsFloat() : DEFAULT_TRANSPARENCY;
