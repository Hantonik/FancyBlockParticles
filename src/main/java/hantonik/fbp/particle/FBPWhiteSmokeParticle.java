...
public class FBPWhiteSmokeParticle extends SmokeParticle implements IKillableParticle {
    ...
    protected FBPWhiteSmokeParticle(ClientWorld level, double x, double y, double z, double xd, double yd, double zd, float scale) {
        ...
        this.multiplier = FancyBlockParticles.CONFIG.smoke.isRandomFadingSpeed() ? MathHelper.clamp((float) FBPConstants.RANDOM.nextDouble(0.55D, 1.15D), 0.7F, 1.0F) : 0.75F;
