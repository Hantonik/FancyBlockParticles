...
public class FBPOptionsScreen extends Screen {
    ...
    public FBPOptionsScreen() {
        ...
        this.options = List.of(
                ...
                new FBPToggleButton(0, 0, 275, 20, Component.translatable("button.fbp.fancy_block_breaking"), this.config::isFancyBlockBraking, button -> this.config.setFancyBlockBraking(!this.config.isFancyBlockBraking()), (button, stack, mouseX, mouseY) -> this.renderTooltip(stack, Component.translatable("tooltip.fbp.fancy_block_breaking").append(CommonComponents.NEW_LINE).append(Component.translatable("tooltip.fbp.default")).append(Component.translatable("button.fbp." + defaultConfig.isFancyBlockBraking()).withStyle(defaultConfig.isFancyFlame() ? ChatFormatting.GREEN : ChatFormatting.RED)), mouseX, mouseY)),
